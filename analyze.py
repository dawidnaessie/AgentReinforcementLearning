...
def construct_prompt(log_contents: Dict[str, str], brain_contents: Dict[str, str]) -> str:
    ...
    prompt_sections = [
        ...
        "- Sensory Space (Phase 10: 23 normalized inputs):",
        ...
        "    17-18: Critical Ally Direction Dir X, Dir Y [-1..1] (nearest starving ally < 20% energy)",
        "    19: Enemy Relative Heading [-1..1] (> 0 fleeing/back exposed, < 0 head-on charge)",
        "    20: Local Herd Density of own tribe [0..1]",
        "    21: Proximity to Nearest Wall [0..1] (0 at wall, 1 at center)",
        "    22: Self Energy Level [0..1]",
